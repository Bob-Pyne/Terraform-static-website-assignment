...
resource "aws_cloudfront_distribution" "cloudfront" {
  origin {
    ...
    origin_id   = "S3-cloudproject-static-bucket"
  ...
  comment             = "CloudFront distribution for Bob"
  ...
  default_cache_behavior {
    ...
    target_origin_id = "S3-cloudproject-bucket"
...
resource "aws_cloudfront_origin_access_identity" "origin_access_identity" {
  comment = "Origin Access Identity for Bob"
}
